...
export default function Contact() {
  ...
  const waLink = `https://wa.me/${CONTACT.whatsappNumber}?text=${encodeURIComponent("Hi Three13 Fitness! I'd like to know more about membership.")}`
    ...
    <section id="contact" className="relative mx-auto max-w-7xl px-5 py-24">
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        <div className="glass overflow-hidden rounded-3xl">
          <iframe title="Three13 Fitness location" src={CONTACT.mapsEmbed} className="h-full min-h-[360px] w-full grayscale invert-[0.92] hue-rotate-[60deg]" loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
        </div>
      </div>
    </section>
  )
